...
/**
 * Extracts a font family's base name, e.g. 'Roboto-Regular' => 'Roboto'
 */
const getBaseNameFromFontFamily = family => family.split('-')[0];

/**
 * Extracts a font family's variant name, e.g. 'Roboto-Regular' => 'Regular',
 */
const getVariantNameFromFontFamily = family => family.split('-')[1] || null;
