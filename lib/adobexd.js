...
async function getTextStyles(outputDir) {
  ...
  return Array.isArray(documentLibrary.elements) ? documentLibrary.elements.filter(e => e.type.startsWith('application/vnd.adobe.element.characterstyle')) : undefined;
};
