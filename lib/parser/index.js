...
const parseTokens = async (args, flags) => {
  ...
  if (isSketch(file)) {
    ...
    try {
      ...
      const adobeXDContents = await getAdobeXDContents(file, outputDir);

      return {
        colors: adobeXDContents.colorTokens,
        textStyles: adobeXDContents.textStyleTokens,
        gradients: adobeXDContents.gradientTokens,
        blurs: adobeXDContents.blurTokens,
        borders: adobeXDContents.borderTokens,
        shadows: adobeXDContents.shadowTokens,
